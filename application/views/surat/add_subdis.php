	...
	<div class="card">
		...
		<div class="card-body ">
			...
			if($this->input->get('ns')){
				echo"<form class='form-horizontal' id='editsub' action='";echo base_url();echo "surat/add_subdisp' method='post' >";
			}
			?>
			<div class=form-group>
				...
				<div class="row">
					...
					<?php
							...
							<select class="form-control" name="sub" id="sub" required>
								<?php 
									foreach ($namasub as $sub):
										echo "<option value='$sub->nama_sub'>$sub->nama_sub</option>";
									endforeach;
								?>
							</select>
							
							<?php
						}else if($this->session->userdata('kd_jabatan')==3){
							?>
							<select class="form-control" name="sub" id="sub" required>
						...
						else if($this->session->userdata('kd_jabatan')==4){
							?>
					...
					<div class="col-sm-9">
                        ...
                        if($cat1==""){
                                ...
                                ";
                                echo "
                                <textarea class='form-control' name='cat1' id='cat1' rows='4' required></textarea>
                                ";
                            ...
                            ";
                            echo "
                            <textarea class='form-control' name='cat2' id='cat2' rows='3' required></textarea>
                            ";
